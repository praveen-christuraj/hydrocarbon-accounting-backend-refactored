...
from sqlalchemy import and_, create_engine, func, inspect, literal, or_, text
...
@app.get("/system-notifications", response_model=list[SystemNotificationResponse])
...
@app.post("/system-notifications", response_model=SystemNotificationResponse)
...
@app.put("/system-notifications/{notification_id}", response_model=SystemNotificationResponse)
...
@app.post("/system-notifications/{notification_id}/publish", response_model=SystemNotificationResponse)
...
@app.post("/system-notifications/{notification_id}/deactivate", response_model=SystemNotificationResponse)
...
@app.get("/system-notifications/my", response_model=list[SystemNotificationResponse])
...
@app.get("/system-notifications/active", response_model=list[SystemNotificationResponse])
...
@app.post("/system-notifications/{notification_id}/dismiss", response_model=SystemNotificationResponse)
...
@app.post("/system-notifications/{notification_id}/acknowledge", response_model=SystemNotificationResponse)
...
@app.get("/system-notifications/{notification_id}/delivery-report", response_model=list[SystemNotificationReceiptResponse])
...
@app.middleware("http")
async def backup_restore_maintenance_middleware(request, call_next):
    if restore_maintenance_state.get("active") and request.method != "OPTIONS":
        ...
        if not path.startswith(allowed_prefixes):
            return JSONResponse(
                status_code=503,
                content={
                    "detail": restore_maintenance_state.get("message")
                    or "System is in backup restore maintenance mode",
                    "request_number": restore_maintenance_state.get("request_number"),
                    "started_at": restore_maintenance_state.get("started_at"),
                },
            )
...
@app.get("/backup-settings", response_model=BackupSettingsResponse)
...
@app.put("/backup-settings", response_model=BackupSettingsResponse)
...
@app.get("/backups", response_model=list[BackupJobResponse])
def get_backup_jobs(
    status: str | None = None,
...
@app.post("/backups/manual", response_model=BackupJobResponse)
...
@app.post("/backups/{backup_id}/verify-checksum")
...
@app.delete("/backups/{backup_id}", response_model=BackupJobResponse)
...
@app.get("/backup-restore-requests", response_model=list[BackupRestoreRequestResponse])
...
@app.post("/backup-restore-requests", response_model=BackupRestoreRequestResponse)
...
@app.post("/backup-restore-requests/{request_id}/approve", response_model=BackupRestoreRequestResponse)
...
@app.post("/backup-restore-requests/{request_id}/reject", response_model=BackupRestoreRequestResponse)
...
@app.post("/backup-restore-requests/{request_id}/cancel", response_model=BackupRestoreRequestResponse)
...
@app.get(
    "/backup-restore-requests/{request_id}/validations",
...
@app.post(
    "/backup-restore-requests/{request_id}/validate",
...
@app.post(
    "/backup-restore-requests/{request_id}/execute",
